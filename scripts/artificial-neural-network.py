...
def main():
    ...
    standardised_training_data, standardised_validation_data, standardised_testing_data = (
    ...
    flood_predictor = FloodPredictor(
        hidden_layer_weights, hidden_layer_biases, output_layer_weights, output_layer_bias
    )
